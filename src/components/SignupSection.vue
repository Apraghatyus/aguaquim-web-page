<!--
  SignupSection.vue - Sección de inscripción / llamado a la acción.

  Tarjeta grande con fondo azul corporativo que invita al visitante
...
-->
<template>
  <section id="inscribete" class="section section--alt signup">
    <div class="container">
      <div class="signup-card">
        <div class="signup-content">
          ...
          <div class="signup-actions">
            <!-- WhatsApp: URL dinámica desde el composable de contacto -->
            <a
              :href="whatsappUrl"
              target="_blank"
            ...
            <!-- Email: URL dinámica desde el composable de contacto -->
